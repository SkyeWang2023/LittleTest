...
void bc1(void) {
  ...
  strlen(str);             // #defect#USE_UNTERMINATED_STRING
}
...
void bc1a(void) {
  ...
  char str[12] = "welcome home";
  char buf[12];
  sprintf(buf, "%s", str); // #defect#USE_UNTERMINATED_STRING
...
void bc2(void) {
  ...
  char str[12] = "Welcome home";
  printf("%s", str); // #defect#USE_UNTERMINATED_STRING
}
...
void bc4(void) {
  ...
  dest[11] = '\0';
  strncpy(dest, src, 3);
  strlen(dest); // #defect#USE_UNTERMINATED_STRING
}
...
void bc7(void) {
  ...
  char dest[13];
  strcpy(dest, src); // #defect#USE_UNTERMINATED_STRING
}
...
void test03(int s, void* p,int x) {
  ...
  char			hdlen[20];
    ...
    sprintf(hdlen, ", H%c=%u", dirletter[x],100);  // #nodefect#USE_UNTERMINATED_STRING
...
void test04(int s, void* p,int x) {
  ...
  char			hdlen[20];
    ...
    sprintf(hdlen, ", %p", dirletter);  // #nodefect#USE_UNTERMINATED_STRING
...
void test05(int s, void* p,int x) {
  ...
  char			hdlen[20];
    ...
    sprintf(hdlen, "%s=%s", &dirletter[x],dirletter);  // #defect#USE_UNTERMINATED_STRING
...
void test06(int s, void* p,int x) {
  ...
  // #nodefect#USE_UNTERMINATED_STRING
...
void test07(int s, int x) {
  ...
  char* p = dirletter;
    ...
    sprintf(hdlen, "%s", p+1);  // #defect#USE_UNTERMINATED_STRING
...
void test09(int s, int x) {
  ...
  sprintf(hdlen, "%s", &p[1]);  // #nodefect#USE_UNTERMINATED_STRING
}
...
void test10(int s, int x) {
  ...
  void* p = dirletter;
    ...
    sprintf(hdlen, "%s", (char*)(p+1));  // #defect#USE_UNTERMINATED_STRING
...
void test11(int s, void* p,int x) {
  ...
  char* format = "%s";
    ...
    sprintf(hdlen, format, dirletter);  // #defect#USE_UNTERMINATED_STRING
...
void test13(int s, void* p,int x) {
  ...
  char* format = "%p,%c";
    ...
    sprintf(hdlen, format, dirletter,dirletter[0]);  // #defect#USE_UNTERMINATED_STRING 
...
void test14(int s, int x) {
  ...
  void* p = dirletter;
    ...
    sprintf(hdlen, "%n", p);  // #defect#USE_UNTERMINATED_STRING
...
void test15(int s, int x) {
  ...
  char* p = dirletter;
    ...
    sprintf(hdlen, "%c", p[1]);  // #nodefect#USE_UNTERMINATED_STRING
...
void test16(int s, void* p,int x) {
  ...
  char* format = "%s,%s";
    ...
    sprintf(hdlen, format, dirletter,dirletter);  // #defect#USE_UNTERMINATED_STRING 
...
void test17(int s, void* p,int x) {
  ...
  char* format = "%c,%s";
    ...
    sprintf(hdlen, format, dirletter[0],dirletter);  // #defect#USE_UNTERMINATED_STRING 
...
void test18(int s, int x) {
  ...
  char* format = "%s,%s";
    ...
    sprintf(hdlen, format, dirletter,p);  // #defect#USE_UNTERMINATED_STRING 
...
void test19(int s, void* p,int x) {
  ...
  char* format = "%c";
    ...
    sprintf(hdlen, format, dirletter[0]);  // #nodefect#USE_UNTERMINATED_STRING 
...
void test23() {
  ...
  sprintf(hdlen, format, s.p,dirletter);  // #defect#USE_UNTERMINATED_STRING 
...
void test24() {
  ...
  char* p = dirletter;
    ...
    sprintf(hdlen, "%s=%s", p,dirletter);  // #defect#USE_UNTERMINATED_STRING
...
void test25(char**p) {
  char c_str[3] = "abc";
  *p = c_str;
  printf("%s\n", *p);  // #defect#USE_UNTERMINATED_STRING
}
