...
void test05(int s, void* p,int x) {
  ...
  char			hdlen[20];
    ...
    sprintf(hdlen, "%s=%s", &dirletter[x],dirletter);  
...
void test11(int s, void* p,int x) {
  ...
  char* format = "%s";
    ...
    sprintf(hdlen, format, dirletter);  
...
void test13(int s, void* p,int x) {
  ...
  char* format = "%p,%c";
    ...
    sprintf(hdlen, format, dirletter,dirletter[0]);   
...
void test16(int s, void* p,int x) {
  ...
  char* format = "%s,%s";
    ...
    sprintf(hdlen, format, dirletter,dirletter);   
...
void test17(int s, void* p,int x) {
  ...
  char* format = "%c,%s";
    ...
    sprintf(hdlen, format, dirletter[0],dirletter);   
...
void test18(int s, int x) {
  ...
  char* format = "%s,%s";
    ...
    sprintf(hdlen, format, dirletter,p);   
...
void test23() {
  ...
  sprintf(hdlen, format, s.p,dirletter);   
